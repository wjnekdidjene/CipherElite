# =============================================================================
#  Плагин: Помощь (Максимальная версия)
#  Версия: 3.0.0
#  Категория: utilities
# =============================================================================
...
def init(client):
    ...
    description = "📚 Помощь - Максимальная система помощи CipherElite"
...
async def register_commands():
    ...
    async def plugins_handler(event):
        try:
            ...
            msg = f"📦 **ПЛАГИНЫ CIPHERELITE**\n"
            msg += f"{'═' * 35}\n\n"
            
            # Сортируем по количеству команд (по убыванию)
    ...
    async def helpstats_handler(event):
        try:
            ...
            # Среднее количество команд
            avg = total_commands / total_plugins if total_plugins > 0 else 0
            
            # Время работы системы помощи
            help_uptime = "С момента запуска"
            ...
            msg += f"⏱ **Время работы:** {help_uptime}\n"
