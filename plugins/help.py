# =============================================================================
#  Плагин: Помощь (TERAZM) — БЕЗ ИНЛАЙН КНОПОК
#  Версия: 1.0.0
#  Категория: utilities
# =============================================================================
...
PLUGIN_DESCRIPTIONS = {
    "afk": "Установите статус 'Отошёл' с причиной. Статистика и уведомления об упоминаниях.",
    "alive": "Проверьте статус бота и задержку соединения.",
